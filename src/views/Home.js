...
const Home = () => {
    ...
    return (
        <div className="text-center container px-3 pt-5">
            ...
            <div
                className="mt-[10vh] md:mt-[20vh] shadow-straight text-center rounded-2xl p-3.5 w-full md:w-1/2 xl:w-1/3  mx-auto">
                <span className="text-purpledark font-semibold text-xl">Кто ты сегодня?</span>
                <div className="flex flex-col md:flex-row mt-2">
                    <div className="relative w-1/2 mx-auto">
                        <div
                            className="change aspect-square rounded-full flex p-2.5 cursor-pointer absolute btn bottom-0 right-0">
